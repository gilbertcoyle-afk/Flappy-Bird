 ...
 */
export const submitScore = async (scorePayload: ScorePayload, options?: RequestInit): Promise<ScoreResult> => {
...
export const getSubmitScoreMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitScore>>, TError,{data: BodyType<ScorePayload>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof submitScore>>, TError,{data: BodyType<ScorePayload>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof submitScore>>, {data: BodyType<ScorePayload>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SubmitScoreMutationBody = BodyType<ScorePayload>
    export type SubmitScoreMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Submit or update a player's score
 */
export const useSubmitScore = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitScore>>, TError,{data: BodyType<ScorePayload>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof submitScore>>,
        TError,
        {data: BodyType<ScorePayload>},
        TContext
      > => {
      return useMutation(getSubmitScoreMutationOptions(options));
    }

export const getPerformPrestigeUrl = () => {
 ...
 */
export const performPrestige = async ( options?: RequestInit): Promise<PrestigeResponse> => {

  return customFetch<PrestigeResponse>(getPerformPrestigeUrl(),
  {
    ...options,
    method: 'POST'
...
export const getPerformPrestigeMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof performPrestige>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof performPrestige>>, TError,void, TContext> => {

const mutationKey = ['performPrestige'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof performPrestige>>, void> = () => {


          return  performPrestige(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PerformPrestigeMutationResult = NonNullable<Awaited<ReturnType<typeof performPrestige>>>

    export type PerformPrestigeMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Perform a prestige rebirth
 */
export const usePerformPrestige = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof performPrestige>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof performPrestige>>,
        TError,
        void,
        TContext
      > => {
      return useMutation(getPerformPrestigeMutationOptions(options));
    }
